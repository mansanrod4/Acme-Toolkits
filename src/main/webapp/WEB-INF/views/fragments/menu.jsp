...
<acme:menu-bar code="master.menu.home">
	...
	<acme:menu-right>
		...
		<acme:menu-option code="master.menu.user-account" access="isAuthenticated()">
			<acme:menu-suboption code="master.menu.user-account.list-inventor" action="/authenticated/user-account/list-inventor"/>
			<acme:menu-suboption code="master.menu.user-account.list-patron" action="/authenticated/user-account/list-patron"/>
