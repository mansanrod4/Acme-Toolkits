...
<%@tag language="java" import="java.util.Collection,java.util.ArrayList,java.util.Map,acme.framework.helpers.JspHelper"%>
...
<table id="list" class="table table-striped table-condensed table-hover nowrap w-100">
	...
	<tbody>
		<jstl:if test="${list$size >= 1}">
			<jstl:forEach var="index" begin="${0}" end="${list$size - 1}">
...
<acme:message var="i18nFileUri" code="default.datatables.language"/>
